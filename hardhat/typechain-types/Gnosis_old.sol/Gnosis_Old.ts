...
export declare namespace Gnosis_Old {
...
export interface Gnosis_OldInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, Gnosis_Old.SignatureStruct[]]
  ): string;
  encodeFunctionData(
...
export interface Gnosis_Old extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Gnosis_OldInterface;
  ...
  functions: {
    ...
    execute(
      ...
      sigs: Gnosis_Old.SignatureStruct[],
